...
const Login = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-r from-stone-100 to-sky-100'>
      <img onClick={()=>navigate('/')} src={assets.logo1} alt="" className='absolute left-5 sm:left-20 top-5 w-45 sm:w-50 cursor-pointer'/>
      ...
      <form onSubmit={onSubmitHandler}>
        {state === "Sign Up" && (
            <div className='mb-4 flex items-center gap-3 w-full px-2 py-2.5 bg-[#1B1A55]'>
        ...
        <div onChange = {e => setPassword(e.target.value)} value={password} className='mb-4 flex items-center gap-3 w-full px-2 py-2.5 bg-[#1B1A55]'>
      ...
      {state === "Sign Up" ? (<p className='text-gray-400 text-center text-sm mt-4 '>
